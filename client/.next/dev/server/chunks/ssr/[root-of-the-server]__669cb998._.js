...
const AuthProvider = ({ children })=>{
    ...
    const checkUserLoggedIn = async ()=>{
        try {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAPI"])('/auth/me', {
                headers: {
    ...
    const login = async (email, password)=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAPI"])('/auth/login', {
            method: 'POST',
            body: JSON.stringify({
                email,
                password
    ...
    const register = async (name, email, password)=>{
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAPI"])('/auth/register', {
            method: 'POST',
            body: JSON.stringify({
                name,
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__669cb998._.js.map